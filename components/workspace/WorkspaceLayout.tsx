      ...
      <main className="flex-1 flex flex-col lg:flex-row gap-4 p-4 md:p-6 lg:p-8 min-h-0 overflow-hidden relative">
        <AnimatePresence initial={false}>
          ...
          {(viewMode === "split" || viewMode === "graph") && (
            <motion.div
              ...
              className="min-w-0 min-h-0 flex flex-col overflow-hidden"
            >
              <CornerBox className="flex-1 flex flex-col min-h-0 relative">
                <div className="border-b border-zinc-200 dark:border-zinc-800 pb-2 mb-4 flex justify-between items-center shrink-0">
        ...
        <div className="absolute bottom-2 left-4 md:left-8 z-10 text-[10px] text-zinc-400 tracking-wider">
          ...
          <a
            ...
            className="text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors duration-200 no-underline font-bold"
          >
            Riki Kashyap
          </a>
        </div>
